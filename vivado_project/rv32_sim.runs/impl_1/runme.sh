...
HD_PWD='C:/Users/37664/Desktop/code/VerilogProjects/vivado_project/rv32_sim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rv32_top.tcl -notrace
